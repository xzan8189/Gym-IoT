...
def build_msgBody(username: str, machine: str) -> str:
    ...
    print(f"Machine: {machine}, Calories lost on machine: {value_calories_spent}" + str())
...
if __name__ == '__main__':
    ...
    randomQueue = "Elliptical_bike"
    username = "xzan8189"
    msg_body = build_msgBody(username=username, machine=randomQueue)
